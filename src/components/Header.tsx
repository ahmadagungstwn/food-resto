...
const Header = ({ userName = "Franzz", location = "Jakarta Selatan", avatarUrl }: HeaderProps) => {
  return (
      ...
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-full bg-secondary overflow-hidden border-2 border-primary/30">
          {avatarUrl ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-primary/40 to-primary/20 flex items-center justify-center text-foreground font-bold text-lg">
              {userName.charAt(0)}
            </div>
          )}
        </div>
